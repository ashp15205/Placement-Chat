    ...
    <>
      ...
      <section id="about" className="mt-16 w-full max-w-5xl animate-in fade-in slide-in-from-bottom-6 duration-1000">
        <div className="frost-strong rounded-[40px] p-8 sm:p-14 space-y-10 text-left">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2 text-[10px] font-black uppercase tracking-widest">
            <Link href="/privacy" className="soft-pill rounded-full px-6 py-3 text-slate-700 hover:text-slate-900 transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="soft-pill rounded-full px-6 py-3 text-slate-700 hover:text-slate-900 transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
